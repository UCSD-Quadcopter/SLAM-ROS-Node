...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /root/catkin_ws/src/main)
  set(main_DEVEL_PREFIX /root/catkin_ws/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Ronak Shah <ronakshah@ieee.org>, Nick Nebel <nick.thenebels@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/install/lib;/root/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(main_EXPORTED_TARGETS "main_generate_messages_cpp;main_generate_messages_eus;main_generate_messages_lisp;main_generate_messages_nodejs;main_generate_messages_py")
...
set(pkg_cfg_extras "main-msg-extras.cmake")
